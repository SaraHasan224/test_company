...
@section('page_title',env('APP_NAME').' - Companies')
@section('parent_module_breadcrumb_title','Company Management')
...
@section('child_module_breadcrumb_title','Companies')
...
{{--                        {{}}--}}
                        ...
                        <div class="nav">
                            ...
                            <a data-toggle="tab" href="#tab-eg2-2" id="officeListing"
                               class="btn-pill btn-wide mr-1 ml-1 btn btn-outline-alternate btn-sm disabled">Office</a>
                            <a data-toggle="tab" href="#tab-eg2-3" id="employeeListing"
                               class="btn-pill btn-wide mr-1 ml-1  btn btn-outline-alternate btn-sm disabled">Employees</a>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script>
        $("#create-company").bind("click", function (e) {
            if ($("#company_create_form").valid()) {
                let url = App.Helpers.generateApiURL(
                    App.Constants.endPoints.createCompany
                );
